...
class StatePoliticians extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      data: [],
  ...
  render() {
    ...
    const filtered = this.state.data.filter((p) => {
      return (p.state.toLowerCase().indexOf(this.state.input) > -1);
    });
        ...
        <div className="col-md-12">
          ...
          <div className="col-md-10">
            <AutoComplete
              ...
              style={searchStyle}
              floatingLabelText="Search Politician's State"
...
export default withRouter(StatePoliticians);
